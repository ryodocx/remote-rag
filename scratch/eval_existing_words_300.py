...
def main():
    ...
    report = f"# Evaluation with {len(test_cases)} Phrases Existing in the DB\n\n"
    success_count = 0
    
    for i, case in enumerate(test_cases, 1):
        if i % 10 == 0:
            print(f"Processing query {i}/{len(test_cases)}...")
    ...
    out_path = r"C:\Users\ryotn\.gemini\antigravity\brain\258ce460-7f14-4094-8e10-4ccdcc9fdac5\eval_existing_words_300.md"
